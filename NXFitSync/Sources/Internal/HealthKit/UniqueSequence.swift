...
//  NXFitSync
//
//  Created by IRC Developer on 2024-04-04.
//
...
internal struct UniquedSequence<Base: Sequence, Subject: Hashable> {
  /// The base collection.
...
extension Sequence where Element: Hashable {
    ...
    ///  .
    /// - Complexity: O(1).
    internal func uniqued() -> UniquedSequence<Self, Element> {
...
extension Sequence {
    ...
    internal func uniqued<Subject: Hashable>(
