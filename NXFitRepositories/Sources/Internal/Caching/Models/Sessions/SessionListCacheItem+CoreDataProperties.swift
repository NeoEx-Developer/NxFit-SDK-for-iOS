//
//  SessionListCacheItem+CoreDataProperties.swift
//  nxfit
//
//  Created by IRC Developer on 2023-09-07.
//
//
...
extension SessionListCacheItem {

    @nonobjc internal class func fetchRequest() -> NSFetchRequest<SessionListCacheItem> {
        return NSFetchRequest<SessionListCacheItem>(entityName: "SessionListCacheItem")
    }
    ...
    @NSManaged internal var parent: SessionListCache?
...
extension SessionListCacheItem : Identifiable {
