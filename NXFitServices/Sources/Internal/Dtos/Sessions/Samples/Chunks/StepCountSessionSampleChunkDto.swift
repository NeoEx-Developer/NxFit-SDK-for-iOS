//
//  StepCountSessionSampleChunkDto.swift
//  NXFitCore
//
...
package class StepCountSessionSampleChunkDto : BaseSessionSampleChunkDto {
    ...
    package required init(count: Int, startedOn: Date, endedOn: Date? = nil) {
        self.count = count
